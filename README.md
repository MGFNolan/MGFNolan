...
The following is tech or tools I have worked with, whether it is on an exposure basis, or tech I am very comfortable with. It wouldn't be here if I couldn't have a conversation about it.
...
### Collaboration, Organisation, and Documentation
...
- Making the web accessible to everyone - On one project, I tackled over 2,000 WCAG issues. I am always advocating for inclusive design
- Mentoring and knowledge sharing (ran a bi-weekly Tech Video Club and helped onboard new developers to projects)
...
[![](https://visitcount.itsvg.in/api?id=MGFNolan&icon=0&color=0)](https://visitcount.itsvg.in)
